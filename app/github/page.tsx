...
export default function GithubGuide() {
  return (
    <div className={styles.page}>
      <main className={styles.main}>
        ...
        <h1 className={styles.title}>GitHubの運用ルール：作業ブランチの作り方</h1>
  ...
  └─ develop         ← 他の人の作業も合流してくる場所
       └─ feature/NAME-01   ← あなたが今日作業する場所`}</code>
        ...
        <p className={styles.paragraph}>
          <code>feature/NAME-01</code> の <code>NAME</code> と{" "}
          <code>01</code> は、それぞれ次のように置き換えてください。
        </p>
        <ul className={styles.list}>
          <li>
            <code>NAME</code>：自分の名前やGitHubのユーザー名（ローマ字、
            例: <code>mirena</code>）
          </li>
          <li>
        ...
        <p className={styles.hint}>
          ブランチが作れたら、トップページに戻って「本日のお題」に進みましょう。
        </p>
      </main>
    </div>
  );
